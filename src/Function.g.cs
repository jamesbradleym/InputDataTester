...
namespace InputDataTester
{
    public class Function
    {
        ...
        private IModelStore<InputDataTesterInputs> store;

        public async Task<InputDataTesterOutputs> Handler(InputDataTesterInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<InputDataTesterInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<InputDataTesterInputs>();
                }
            }

            var l = new InvocationWrapper<InputDataTesterInputs,InputDataTesterOutputs> (store, InputDataTester.Execute);
